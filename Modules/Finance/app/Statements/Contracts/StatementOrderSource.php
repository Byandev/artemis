...
/**
 * One system's orders, readable at each of the grains a statement needs.
 *
 ...
 * as a single thing.
 */
interface StatementOrderSource extends ProvidesProductTotals, ProvidesUserProductTotals, ProvidesUserTotals, ProvidesWorkspaceTotals
{
