    ...
    public function rules(): array
    {
        ...
        return [
            'shop_id' => [
                'required',
                'integer',
                // Reject a shop that already belongs to this workspace up front,
                // before the controller makes any POS API call — so the client
                // gets an inline validation error on the field, not an HTTP error.
