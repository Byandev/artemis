...
class AdvertiserPerformanceDailyRecord extends Model
{
    ...
    protected $casts = [
        ...
        'date_to_month_sales_order_delivered' => 'decimal:2',
        'date_to_month_sales_order_returned' => 'decimal:2',
        'date_to_month_sales_order_for_return' => 'decimal:2',
        'date_to_month_parcel_status_rts_rate' => 'decimal:2',
        'date_to_month_parcel_status_delivered' => 'decimal:2',
        'date_to_month_parcel_status_returned' => 'decimal:2',
        'date_to_month_parcel_status_for_return' => 'decimal:2',
        'date_to_month_shipped_out_rts_rate' => 'decimal:2',
        'date_to_month_shipped_out_delivered' => 'decimal:2',
        'date_to_month_shipped_out_returned' => 'decimal:2',
        'date_to_month_shipped_out_for_return' => 'decimal:2',
    ];
