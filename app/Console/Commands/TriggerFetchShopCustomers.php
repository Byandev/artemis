    ...
    public function handle(): void
    {
        Shop::whereNotNull('customers_last_synced_at')
            ...
            ->each(function (Shop $shop) {
                dispatch(new FetchShopCustomers($shop, 1, $shop->customers_last_synced_at ? Carbon::parse($shop->customers_last_synced_at)->unix() : Carbon::now()->subYear()->startOfYear()->unix(), Carbon::now()->unix()))->onQueue('pancake');
            });
    }
}
