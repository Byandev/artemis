...
beforeEach(function () {
    ...
    Storage::fake(config('filesystems.proof_of_payment_disk'));
...
it('attaches a receipt to an invoice', function () {
    ...
    expect($proof->disk)->toBe(config('filesystems.proof_of_payment_disk'));
...
it('streams the receipt when the disk cannot sign a url', function () {
    ...
    config(['filesystems.proof_of_payment_disk' => 'unsigned']);
