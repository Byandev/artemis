...
export default function OrderFrequencyCard({
    workspaceSlug,
    queryParams,
    onDataLoaded,
}: Props) {
    ...
    useEffect(() => {
        ...
        fetch(
            `/workspaces/${workspaceSlug}/rts/analytics/group-by/order-frequency?${p}`,
            ...
            <div className="flex items-center justify-between border-b border-black/6 px-5 py-4 dark:border-white/6">
                <div>
                    ...
                    <p className="mt-0.5 text-[12px] text-gray-400 dark:text-gray-500">
                        RTS rate by number of times a customer has ordered
                    </p>
                </div>
