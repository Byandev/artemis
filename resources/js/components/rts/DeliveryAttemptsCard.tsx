...
export default function DeliveryAttemptsCard({ workspaceSlug, queryParams }: Props) {
    ...
    useEffect(() => {
        ...
        fetch(`/workspaces/${workspaceSlug}/rts/analytics/group-by/delivery-attempts?${p}`, { credentials: 'same-origin' })
