...
export const orderStatusConfig: Record<string, OrderStatusEntry> = {
    'PENDING':            { dot: 'bg-yellow-400',  text: 'text-yellow-700 dark:text-yellow-400',   pill: 'bg-yellow-50 text-yellow-700 dark:bg-yellow-500/10 dark:text-yellow-400' },
    'DELIVERED':          { dot: 'bg-emerald-500', text: 'text-emerald-700 dark:text-emerald-400', pill: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-400' },
    'RIDER OTW':          { dot: 'bg-blue-500',    text: 'text-blue-700 dark:text-blue-400',       pill: 'bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400' },
    'RETURNING':          { dot: 'bg-orange-400',  text: 'text-orange-700 dark:text-orange-400',   pill: 'bg-orange-50 text-orange-700 dark:bg-orange-500/10 dark:text-orange-400' },
    'RESCHEDULED':        { dot: 'bg-purple-400',  text: 'text-purple-700 dark:text-purple-400',   pill: 'bg-purple-50 text-purple-700 dark:bg-purple-500/10 dark:text-purple-400' },
    'CX CBR':             { dot: 'bg-red-500',     text: 'text-red-700 dark:text-red-400',         pill: 'bg-red-50 text-red-700 dark:bg-red-500/10 dark:text-red-400' },
    'RIDER CBR':          { dot: 'bg-red-500',     text: 'text-red-700 dark:text-red-400',         pill: 'bg-red-50 text-red-700 dark:bg-red-500/10 dark:text-red-400' },
    'CANCELLED':          { dot: 'bg-gray-400',    text: 'text-gray-500 dark:text-gray-400',       pill: 'bg-gray-100 text-gray-600 dark:bg-zinc-800 dark:text-gray-400' },
    'WRONG SEGMENT CODE': { dot: 'bg-rose-500',    text: 'text-rose-700 dark:text-rose-400',       pill: 'bg-rose-50 text-rose-700 dark:bg-rose-500/10 dark:text-rose-400' },
    ...
    'INCORRECT NUMBER':   { dot: 'bg-pink-500',    text: 'text-pink-700 dark:text-pink-400',       pill: 'bg-pink-50 text-pink-700 dark:bg-pink-500/10 dark:text-pink-400' },
};
