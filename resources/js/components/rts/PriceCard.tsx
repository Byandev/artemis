...
export default function PriceCard({
    ...
    useEffect(() => {
        ...
        fetch(
            `/workspaces/${workspaceSlug}/rts/analytics/group-by/price?${p}`,
