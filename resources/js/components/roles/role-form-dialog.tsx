...
const RoleFormDialog = ({ workspace, open, onOpenChange, role }: Props) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        request(url, {
            ...
            onError: () => toast.error('Failed to save role. Please check the form.')
        });
    };
                ...
                <div className="px-5 pt-5 pb-4 border-b border-black/6 dark:border-white/6">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-[12px] text-gray-400 dark:text-gray-500 mt-0.5">
                            {isEditing ? 'Edit the permissions and details for this role.' : 'Define a new access level for your workspace.'}
                        </DialogDescription>
                    </DialogHeader>
                </div>
                    ...
                    <div className="space-y-5 px-5 py-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                className="min-h-[100px] w-full rounded-[10px] border border-black/8 bg-stone-50 p-3 font-mono! text-[13px]! text-gray-800 outline-none transition-all focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/15 dark:border-white/8 dark:bg-zinc-800 dark:text-gray-100 resize-none"
                            />
