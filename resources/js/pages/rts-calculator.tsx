...
function compute(i: Inputs) {
    ...
    const costPerRts =
        forward + returnFee + packaging + damageLoss + profitPerOrder;
        ...
        <div className="space-y-1.5">
                    ...
                    <div className="relative">
                        ...
                        {tooltipOpen && (
                            <div className="absolute bottom-full left-1/2 z-10 mb-2 w-56 -translate-x-1/2 rounded-[10px] border border-black/6 bg-white p-3 text-[11px] leading-relaxed text-gray-500 shadow-xl dark:border-white/8 dark:bg-zinc-800 dark:text-gray-400">
                                {tooltip}
                                <div className="absolute -bottom-[5px] left-1/2 h-2.5 w-2.5 -translate-x-1/2 rotate-45 border-r border-b border-black/6 bg-white dark:border-white/8 dark:bg-zinc-800" />
                            </div>
                        )}
                    </div>
                )}
            ...
            <div className="flex items-center overflow-hidden rounded-[10px] border border-black/8 bg-stone-50 transition-all focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-500/15 dark:border-white/8 dark:bg-zinc-800 dark:focus-within:border-emerald-400">
                ...
                <input
                    ...
                    min={min}
                    max={max}
                    className="h-10 w-full flex-1 [appearance:textfield] bg-transparent px-3 font-mono! text-[13px]! font-medium text-gray-800 outline-none placeholder:text-gray-300 dark:text-gray-100 dark:placeholder:text-gray-600 [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                />
                {suffix && (
    ...
    return (
        <>
            <Head title="RTS Calculator — See how much failed deliveries cost you | Artemis">
                <meta
                    name="description"
                    content="Free tool for Philippine COD sellers. Calculate your real RTS bleed in pesos per month and year. See where the money goes."
                />
                <meta
                    property="og:title"
                    content="RTS Calculator — See how much failed deliveries cost you | Artemis"
                />
                <meta
                    property="og:description"
                    content="Free tool for Philippine COD sellers. Calculate your real RTS bleed in pesos per month and year."
                />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        description:
                            'Calculate how much return-to-sender is costing your Philippine COD e-commerce business.',
            ...
            <div className="relative min-h-screen overflow-hidden bg-white text-gray-900 dark:bg-zinc-950 dark:text-gray-100">
                ...
                <div className="pointer-events-none absolute right-0 bottom-0 h-[500px] w-[500px] bg-[radial-gradient(circle,rgba(16,211,161,0.06),transparent_60%)]" />
                <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.025)_1px,transparent_1px),linear-gradient(90deg,rgba(0,0,0,0.025)_1px,transparent_1px)] bg-[size:60px_60px] dark:bg-[linear-gradient(rgba(255,255,255,0.012)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.012)_1px,transparent_1px)]" />
                ...
                <nav className="sticky top-0 z-50 border-b border-gray-200/80 bg-white/80 backdrop-blur-2xl dark:border-white/6 dark:bg-zinc-950/80">
                    <div className="mx-auto flex max-w-[1200px] items-center justify-between px-5 py-4 md:px-10">
                        ...
                        <div className="flex items-center gap-6 text-sm">
                            ...
                            <Link
                                href="/rts-calculator"
                                className="hidden text-[13px] font-medium text-brand-600 transition-colors hover:text-brand-500 md:block dark:text-brand-400 dark:hover:text-brand-300"
                            >
                                RTS Calculator
                            </Link>
                ...
                {/* Hero */}
                <section className="relative px-5 pt-20 pb-6 md:px-10 md:pt-28 lg:pt-32">
                    <div className="relative mx-auto max-w-[1200px] text-center">
                        <div className="mb-8 inline-flex items-center gap-2.5 rounded-full border border-brand-200/60 bg-brand-50/80 px-4 py-2 dark:border-brand-500/15 dark:bg-brand-500/8">
                            ...
                            <span className="font-mono text-[10px] font-semibold tracking-[0.2em] text-brand-700 uppercase dark:text-brand-400">
                                Free tool · No signup required
                            </span>
                        </div>
                        <h1 className="mx-auto mb-6 text-[clamp(2.25rem,5.5vw,3.75rem)] leading-[1.05]! font-bold! tracking-tight">
                        ...
                        <p className="mx-auto mb-3 max-w-lg text-[17px] leading-relaxed text-gray-500 dark:text-gray-400">
                            Enter your numbers below. We'll show you the bleed —
                            in pesos, per month, per year. No guesswork.
                        </p>
                        <p className="mx-auto max-w-lg text-[13px] leading-relaxed text-gray-400 dark:text-gray-500">
                            Every COD seller has an RTS bleed. Most just don't
                            know how big it is.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="relative mx-auto grid max-w-[1200px] items-start gap-8 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)] lg:gap-10">
                        ...
                        <div className="space-y-6 lg:sticky lg:top-28">
                            <div className="overflow-hidden rounded-2xl border border-black/6 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                <div className="border-b border-black/4 bg-stone-50/80 px-6 py-5 dark:border-white/5 dark:bg-white/[0.02]">
                                    <h2 className="text-[14px] font-bold tracking-tight text-gray-900 dark:text-gray-100">
                                        Your business numbers
                                    </h2>
                                    <p className="mt-1 font-mono text-[10px] tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                        Adjust the values — results update
                                        instantly
                                    </p>
                                </div>
                                <div className="space-y-5 px-6 py-6">
                                    ...
                                    <NumberInput
                                        id="rtsPct"
                                        label="Current RTS rate"
                                        value={inputs.rtsPct}
                                        onChange={(v) => set('rtsPct', v)}
                                        suffix="%"
                                        max={100}
                                        tooltip="Don't know? PH average is 25–35%. If you're on TikTok Shop COD, it could be 30–45%."
                                    />
                                    <NumberInput
                                        id="marginPct"
                                        label="Profit margin"
                                        ...
                                        suffix="%"
                                        max={100}
                                        tooltip="(Revenue − All costs) ÷ Revenue × 100. Not sure? Most COD sellers in PH sit between 25–45%."
                                    />
                                </div>
                            </div>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mt-0.5 font-mono text-[10px] tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                            Ad spend, shipping, packaging,
                                            damage & COGS
                                        </p>
                                    </div>
                                    <div
                                        className={`flex h-7 w-7 items-center justify-center rounded-full border transition-all ${showAdvanced ? 'rotate-180 border-emerald-400 bg-emerald-50 dark:border-emerald-500/40 dark:bg-emerald-500/10' : 'border-gray-200 dark:border-white/10'}`}
                                    >
                                        <svg
                                            className={`h-3.5 w-3.5 ${showAdvanced ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400'}`}
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                            strokeWidth={2.5}
                                ...
                                {showAdvanced && (
                                    <div className="space-y-5 border-t border-black/4 px-6 py-6 dark:border-white/5">
                                        <NumberInput
                                            ...
                                            value={inputs.adCostPerOrder}
                                            onChange={(v) =>
                                                set('adCostPerOrder', v)
                                            }
                                            prefix="₱"
                                            tooltip="Your ad cost to acquire one order. Total monthly ad spend ÷ total orders."
                                        />
                                        <NumberInput
                                            id="forward"
                                        ...
                                        <NumberInput
                                            id="packaging"
                                            label="Packaging cost per parcel"
                                        ...
                                        <NumberInput
                                            id="damagePct"
                                            label="Damage rate on returns"
                                            value={inputs.damagePct}
                                            onChange={(v) =>
                                                set('damagePct', v)
                                            }
                                            suffix="%"
                        ...
                        <div className="space-y-6" aria-live="polite">
                            ...
                            <div className="overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                <div className="flex items-center gap-4 px-7 py-6 md:px-8">
                                    ...
                                    <div className="flex-1">
                                        <p className="font-mono text-[10px] tracking-[0.2em] text-gray-400 uppercase dark:text-gray-500">
                                            Failed parcels per month
                                        </p>
                                ...
                                <div className="border-t border-gray-100 bg-gray-50/40 px-7 py-3 dark:border-white/5 dark:bg-white/[0.015]">
                                    <p className="text-[12px] leading-relaxed text-gray-400 dark:text-gray-500">
                                        Out of {fmt(debounced.orders)} monthly
                                        orders,{' '}
                                        <span className="font-semibold text-gray-600 dark:text-gray-300">
                                            {debounced.rtsPct}% are returned
                                        </span>{' '}
                                        — that's {fmt(r.failedOrders)} parcels
                                        that cost you money with zero revenue.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                <div className="px-7 py-7 md:px-8">
                                    <div className="mb-5 flex items-start justify-between">
                                        <div>
                                            ...
                                            <h3 className="mt-1.5 text-[15px] font-bold tracking-tight text-gray-900 dark:text-gray-100">
                                                Unrealized profit
                                            </h3>
                                        </div>
                                        <div className="flex h-8 items-center rounded-full border border-gray-200 bg-gray-50 px-3 font-mono text-[10px] tracking-[0.15em] text-gray-400 uppercase dark:border-white/8 dark:bg-white/[0.03] dark:text-gray-500">
                                            Margin only
                                        </div>
                                    </div>
                                ...
                                {/* Explanation */}
                                <div className="border-t border-gray-100 bg-gray-50/40 px-7 py-5 md:px-8 dark:border-white/5 dark:bg-white/[0.015]">
                                    <p className="mb-3 text-[12px] font-semibold tracking-[0.1em] text-gray-400 uppercase dark:text-gray-500">
                                        What this counts
                                    </p>
                                    <p className="mb-4 text-[13px] leading-relaxed text-gray-500 dark:text-gray-400">
                                        This is the profit you{' '}
                                        <span className="font-semibold text-gray-700 dark:text-gray-300">
                                            would have earned
                                        </span>{' '}
                                        from each failed order — the sale that
                                        didn't happen. It only counts lost
                                        margin, nothing else. Think of it as the{' '}
                                    ...
                                    <div className="rounded-lg border border-gray-200/80 bg-white px-4 py-3 dark:border-white/6 dark:bg-zinc-800/60">
                                        <p className="font-mono text-[11px] leading-relaxed text-gray-500 dark:text-gray-400">
                                            <span className="text-gray-400 dark:text-gray-500">
                                                {fmt(r.failedOrders)} failed
                                                orders
                                            </span>{' '}
                                            ×{' '}
                                            <span className="text-gray-400 dark:text-gray-500">
                                                ₱{fmt(debounced.aov)} AOV
                                            </span>{' '}
                                            ×{' '}
                                            <span className="text-gray-400 dark:text-gray-500">
                                                {debounced.marginPct}% margin
                                            </span>{' '}
                                            ={' '}
                            ...
                            <div className="relative overflow-hidden rounded-2xl border-2 border-brand-500/80 shadow-xl shadow-brand-500/8 dark:border-brand-500/60">
                                {/* Glow effects */}
                                <div className="pointer-events-none absolute -top-20 -right-20 h-52 w-52 rounded-full bg-brand-500/15 blur-3xl" />
                                ...
                                <div className="relative bg-gradient-to-b from-brand-50/90 to-white dark:from-brand-500/[0.06] dark:to-zinc-900">
                                    <div className="px-7 py-8 md:px-8">
                                        <div className="mb-6 flex items-start justify-between">
                                            <div>
                                                <p className="font-mono text-[10px] tracking-[0.2em] text-brand-600 uppercase dark:text-brand-400">
                                                    Full RTS bleed
                                                </p>
                                                <h3 className="mt-1.5 text-[15px] font-bold tracking-tight text-gray-900 dark:text-gray-100">
                                            ...
                                            <div className="flex h-8 items-center rounded-full border border-brand-300 bg-brand-50 px-3 font-mono text-[10px] tracking-[0.15em] text-brand-600 uppercase dark:border-brand-500/30 dark:bg-brand-500/10 dark:text-brand-400">
                                                All costs
                                            </div>
                                        </div>

                                        <div className="text-[clamp(2rem,5vw,3.25rem)] font-bold tracking-tight text-brand-600 italic dark:text-brand-400">
                                            {fmtPeso(r.fullMonthly)}
                                            <span className="ml-2 text-lg font-normal text-gray-400 not-italic">
                                                / month
                                            </span>
                                        </div>
                                    ...
                                    {/* Explanation */}
                                    <div className="border-t border-brand-200/50 bg-brand-50/30 px-7 py-5 md:px-8 dark:border-brand-500/10 dark:bg-brand-500/[0.03]">
                                        <p className="mb-3 text-[12px] font-semibold tracking-[0.1em] text-brand-600/70 uppercase dark:text-brand-400/70">
                                            What this counts
                                        </p>
                                        <p className="mb-4 text-[13px] leading-relaxed text-gray-600 dark:text-gray-400">
                                            ...
                                            of every RTS goes far beyond lost
                                            profit. You paid for the ad that
                                            acquired that customer. You paid to
                                            ship it there. You pay to ship it
                                            back. The packaging is wasted. Some
                                            items come back damaged. This adds
                                            up to the{' '}
                                            <span className="font-semibold text-brand-600 dark:text-brand-400">
                                                true bleed
                                            </span>{' '}
                                            — what RTS actually costs your
                                            business.
                                        </p>

                                        {/* Formula breakdown */}
                                        <div className="space-y-2">
                                            <p className="text-[11px] font-semibold tracking-[0.1em] text-gray-400 uppercase dark:text-gray-500">
                                                Cost per failed parcel ={' '}
                                                {fmtPeso(r.costPerRtsWithAds)}
                                            </p>
                                            <div className="space-y-1.5 rounded-lg border border-gray-200/80 bg-white px-4 py-3 dark:border-white/6 dark:bg-zinc-800/60">
                                                {[
                                                    {
                                                        ...
                                                        value: r.costPerAcquisition,
                                                        desc: 'The ad cost to acquire this customer',
                                                    },
                                                    {
                                                        label: 'Forward shipping',
                                                        value: r.forward,
                                                        desc: 'You paid to send it',
                                                    },
                                                    {
                                                        label: 'Return shipping',
                                                        value: r.returnFee,
                                                        desc: 'You pay to get it back',
                                                    },
                                                    {
                                                        label: 'Packaging',
                                                        value: r.packaging,
                                                        desc: 'Box, tape, filler — wasted',
                                                    },
                                                    {
                                                        label: 'Damage loss',
                                                        value: r.damageLoss,
                                                        desc: `${debounced.damagePct}% of items come back unsellable`,
                                                    },
                                                    {
                                                        label: 'Unrealized profit',
                                                        value: r.profitPerOrder,
                                                        desc: "The sale that didn't happen",
                                                    },
                                                ].map((row) => (
                                                    <div
                                                        key={row.label}
                                                ...
                                                <div className="mt-2 flex items-center justify-between border-t border-dashed border-gray-200 pt-2 dark:border-white/8">
                                                    ...
                                                    <span className="font-mono text-[13px] font-bold text-brand-600 dark:text-brand-400">
                                                        {fmtPeso(
                                                            r.costPerRtsWithAds,
                                                        )}
                                                    </span>
                ...
                <section className="relative px-5 py-6 md:px-10 md:py-10">
                    <div className="mx-auto max-w-[1200px]">
                        <div className="overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                            <div className="px-7 py-7 md:px-8">
                                <p className="mb-2 font-mono text-[10px] tracking-[0.2em] text-brand-500 uppercase">
                                    Cost anatomy
                                </p>
                                <h3 className="mb-2 text-xl font-bold tracking-tight text-gray-900 md:text-2xl dark:text-gray-100">
                                    Where the{' '}
                                ...
                                <p className="mb-8 max-w-xl text-[13px] leading-relaxed text-gray-400 dark:text-gray-500">
                                    Each segment represents a real cost you
                                    absorb on every returned order. The wider
                                    the segment, the larger its share of your
                                    loss.
                                </p>
                                ...
                                <div className="overflow-x-auto pb-2">
                                    <div
                                        className="flex min-w-[480px] overflow-hidden rounded-xl"
                                        style={{ height: 56 }}
                                    >
                                ...
                                <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
                                    {BAR_SEGMENTS_META.map((seg, idx) => {
                                        ...
                                        return (
                                            <div
                                                key={seg.key}
                                                className="flex items-center gap-2.5 rounded-lg border border-gray-100 px-3 py-2.5 dark:border-white/5"
                                            >
                                                <span
                ...
                <section className="relative overflow-hidden px-5 py-20 md:px-10 md:py-28">
                    <div className="pointer-events-none absolute top-0 left-0 h-px w-full bg-gradient-to-r from-transparent via-gray-200 to-transparent dark:via-white/8" />
                    <div className="mx-auto max-w-[1200px]">
                        <div className="mb-12 max-w-2xl">
                            <p className="mb-4 font-mono text-[10px] tracking-[0.2em] text-brand-500 uppercase">
                                What this really means
                            </p>
                            <h2 className="mb-4 text-[clamp(1.5rem,3.5vw,2.5rem)] leading-tight font-bold tracking-tight">
                            ...
                            <p className="text-[14px] leading-relaxed text-gray-400 dark:text-gray-500">
                                Real numbers, real opportunity cost. This is
                                money leaving your business that could fund
                                growth.
                            </p>
                        </div>
                        ...
                        >
                            {[
                                ...
                                },
                                {
                                    ...
                                    unit: '',
                                    label: 'inventory restocks',
                                    sub: '₱100,000 per batch',
                                    icon: 'M20.25 7.5l-.625 10.632a2.25 2.25 0 01-2.247 2.118H6.622a2.25 2.25 0 01-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125z',
                                },
                            ].map((c, i) => (
                                <div
                                    key={i}
                                    className="group overflow-hidden rounded-2xl border border-gray-200/80 bg-white transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-gray-200/40 dark:border-white/6 dark:bg-zinc-900/80 dark:hover:shadow-black/20"
                                >
                        ...
                        <p className="mt-8 font-mono text-[11px] tracking-[0.15em] text-gray-400 uppercase dark:text-gray-600">
                ...
                <section className="relative overflow-hidden py-24 md:py-32">
                    ...
                    <div className="pointer-events-none absolute top-1/2 left-1/2 h-[600px] w-[800px] -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(ellipse,rgba(16,211,161,0.1),transparent_55%)]" />
                    ...
                    <div className="relative mx-auto max-w-[1200px] px-5 text-center md:px-10">
                        ...
                        <h2 className="mx-auto mb-5 max-w-2xl text-[clamp(1.75rem,4vw,3rem)] leading-tight font-bold tracking-tight">
                            Now imagine cutting
                        ...
                        <p className="mx-auto mb-4 max-w-xl text-[16px] leading-relaxed text-gray-500 dark:text-gray-400">
                            If Artemis helps you reduce RTS by just 10% —
                            typical within 90 days — you'd save:
                        </p>

                        {/* Savings highlight */}
                        <div className="mx-auto mb-10 flex max-w-lg flex-col items-center gap-4 sm:flex-row sm:justify-center sm:gap-8">
                            <div className="text-center">
                                <div className="text-4xl font-bold tracking-tight text-brand-500 md:text-5xl">
                                    {fmtPeso(r.monthlySavings)}
                                </div>
                                <p className="mt-1 text-sm text-gray-400">
                                    every month
                                </p>
                            </div>
                            <div className="hidden h-12 w-px bg-gray-200 sm:block dark:bg-white/8" />
                            <div className="text-center">
                                <div className="text-4xl font-bold tracking-tight text-gray-900 md:text-5xl dark:text-gray-100">
                                    {fmtPeso(r.yearlySavings)}
                                </div>
                                <p className="mt-1 text-sm text-gray-400">
                                    every year
                                </p>
                        ...
                        <p className="mx-auto max-w-md text-[11px] leading-relaxed text-gray-400 dark:text-gray-600">
                            Projection assumes 10% relative reduction in RTS.
                            Actual results vary by product, audience, and
                            courier. We don't promise a specific endpoint.
                        </p>
                    </div>
                </section>
                        ...
                        <div className="flex flex-col items-center justify-between gap-5 rounded-2xl border border-gray-200/80 bg-gray-50/60 px-7 py-6 sm:flex-row dark:border-white/6 dark:bg-white/[0.02]">
                            <div>
                                ...
                                <p className="mt-0.5 text-[13px] text-gray-400 dark:text-gray-500">
                                    Copy a detailed summary to share with your
                                    team or partners.
                                </p>
                            </div>
                            <button
