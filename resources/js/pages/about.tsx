    ...
    return (
        <>
            <Head title="About — Artemis">
                <meta
                    name="description"
                    content="Artemis is the 1st analytics and automation platform built for Philippine COD e-commerce. Learn about our mission to help sellers cut RTS and protect their margin."
                />
            </Head>
            ...
            <div className="relative min-h-screen overflow-hidden bg-white text-gray-900 dark:bg-zinc-950 dark:text-gray-100">
                ...
                {/* Hero */}
                <section className="relative px-5 pt-20 pb-12 md:px-10 md:pt-28">
                    <div className="mx-auto max-w-[720px] text-center">
                        ...
                        <h1 className="mb-6 text-[clamp(2rem,5vw,3.25rem)] leading-tight font-bold tracking-tight">
                        ...
                        <p className="mx-auto max-w-xl text-base leading-relaxed text-gray-500 sm:text-lg dark:text-gray-400">
                            We're building the tools that Philippine COD sellers
                            need to stop guessing and start growing — with real
                            data, real automation, and real results.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="mx-auto max-w-[720px]">
                        <div className="mb-16 border-b border-gray-200/80 pb-16 dark:border-white/6">
                            ...
                            <h2 className="mb-6 text-2xl font-bold tracking-tight sm:text-3xl">
                                Every COD seller deserves to know where their
                                money goes.
                            </h2>
                            <div className="space-y-5 text-[16px] leading-[1.8] text-gray-600 dark:text-gray-400">
                                <p>
                                    The Philippine COD e-commerce market is
                                    massive — billions of pesos flowing through
                                    Facebook pages, TikTok shops, and Shopee
                                    stores every month. But behind the revenue
                                    numbers, most sellers are losing 20-40% of
                                    their shipments to RTS.
                                </p>
                                <p>
                                    That's not a minor inefficiency. It's a
                                    structural problem — and until now, there
                                    hasn't been a platform built specifically to
                                    solve it for Filipino sellers.
                                </p>
                                <p>
                                    Artemis is the{' '}
                                    <strong className="text-gray-900 dark:text-gray-200">
                                        1st analytics and automation platform
                                    </strong>{' '}
                                    purpose-built for Philippine COD e-commerce.
                                    We connect to Pancake POS, pull your data
                                    automatically, and give you the visibility
                                    and tools to cut RTS, improve delivery
                                    success, and keep more of every peso you
                                    earn.
                                </p>
                            </div>
                        </div>
                                ...
                                {[
                                    {
                                        ...
                                        desc: 'Every decision should be backed by real numbers. We make data accessible — not complicated.',
                                    },
                                    {
                                        title: 'Built for COD',
                                        desc: "We don't adapt general e-commerce tools to COD. We build from the ground up for how Filipino COD sellers actually operate.",
                                    },
                                    {
                                        title: 'Visibility first',
                                        desc: "You can't fix what you can't see. Before automation, before optimization — you need to know your numbers.",
                                    },
                                    {
                                        title: 'Progress, not perfection',
                                        desc: 'Moving your RTS from 30% to 25% is worth more than chasing 0%. We help you improve steadily, month over month.',
                                    },
                                ].map((v) => (
                                    <div key={v.title}>
                                        <h3 className="mb-2 text-[15px] font-bold text-gray-900 dark:text-gray-100">
                                            {v.title}
                                        </h3>
                        ...
                        <div>
                            ...
                            <div className="space-y-5 text-[16px] leading-[1.8] text-gray-600 dark:text-gray-400">
                                <p>
                                    In Greek mythology, Artemis was the goddess
                                    of the hunt — precise, focused, and
                                    relentless. We named our platform after her
                                    because that's exactly what we help sellers
                                    do:{' '}
                                    <strong className="text-gray-900 dark:text-gray-200">
                                        hunt down RTS
                                    </strong>{' '}
                                    with precision, and protect their margin
                                    with data.
                                </p>
                                <p>
                                    Every failed parcel is a target. Every
                                    percentage point of RTS reduced is a win.
                                    Artemis gives you the tools to find the
                                    leaks, fix them, and keep your business
                                    growing.
                                </p>
                            </div>
                        </div>
                ...
                <section className="relative overflow-hidden py-20 md:py-28">
                    ...
                    <div className="relative mx-auto max-w-[1200px] px-5 text-center md:px-10">
                        ...
                        <p className="mx-auto mb-8 max-w-md text-[15px] leading-relaxed text-gray-500 dark:text-gray-400">
                            14-day free trial. Connect 1 Pancake page, get 1
                            month of data. No credit card required.
                        </p>
