            ...
            <div className="fixed inset-0 overflow-hidden bg-white dark:bg-zinc-950">
                ...
                {navOpen && (
                    <div className="absolute inset-0 z-40 flex items-center justify-center bg-white/95 backdrop-blur-xl dark:bg-zinc-950/95" onClick={() => setNavOpen(false)}>
                        <div className="grid w-full max-w-3xl grid-cols-3 gap-3 px-6 sm:grid-cols-5" onClick={(e) => e.stopPropagation()}>
                            {SLIDES.map((s, i) => (
                                <button
                                    key={s.id}
                                    onClick={() => goTo(i)}
                    ...
                    {SLIDES.map((slide, i) => (
                        ...
                        >
                            <div className="w-full max-w-5xl py-8">
                                ...
                                {i === 0 && (
                                    <div className="relative text-center">
                                        ...
                                        <Reveal active={a === 0} delay={450}>
                                            <p className="mx-auto mb-10 max-w-lg text-lg leading-relaxed text-gray-500 sm:text-xl dark:text-gray-400">A partnership & equity proposal for the people who helped make this real.</p>
                                        </Reveal>
                                ...
                                {i === 1 && (
                                    <>
                                        <Reveal active={a === 1}><p className="mb-5 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-brand-500">What We Built</p></Reveal>
                                        <Reveal active={a === 1} delay={100}><h2 className="mb-6 max-w-3xl text-[clamp(1.75rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight">The <span className="text-brand-500 italic">first</span> analytics platform for PH COD e-commerce.</h2></Reveal>
                                        <Reveal active={a === 1} delay={200}><p className="mb-14 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">Artemis connects to Pancake POS and gives COD sellers full visibility into their sales, deliveries, RTS rates, and parcel journeys. No one else does this.</p></Reveal>
                                            ...
                                            {[
                                                ...
                                                <Reveal key={f.t} active={a === 1} delay={300 + fi * 80}>
                                                    <div className="rounded-2xl border border-gray-200/80 bg-white p-6 dark:border-white/6 dark:bg-zinc-900/80">
                                                        ...
                                                        <h3 className="mb-1.5 text-[14px] font-bold">{f.t}</h3>
                                ...
                                {i === 2 && (
                                    <>
                                        <Reveal active={a === 2}><p className="mb-5 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-brand-500">Traction</p></Reveal>
                                        <Reveal active={a === 2} delay={100}><h2 className="mb-6 max-w-3xl text-[clamp(1.75rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight">Real sellers. <span className="text-brand-500 italic">Real results.</span></h2></Reveal>
                                        <Reveal active={a === 2} delay={200}><p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">Artemis is already in production with beta users. The product works, the data flows, and sellers are seeing their real RTS numbers for the first time.</p></Reveal>
                                        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                                            {[
                                                { n: '1st', l: 'Mover advantage', s: 'No competitors in PH COD analytics' },
                                                { n: '4', l: 'Beta case studies', s: 'Proven RTS reduction across brands' },
                                                { n: '30M+', l: 'Parcels tracked', s: 'Across beta seller accounts' },
                                                { n: '17-48%', l: 'RTS reduction achieved', s: 'Documented results from real sellers' },
                                            ].map((c, ci) => (
                                                <Reveal key={c.l} active={a === 2} delay={300 + ci * 100}>
                                                    <div className="rounded-2xl border border-gray-200/80 bg-white p-7 dark:border-white/6 dark:bg-zinc-900/80">
                                                        <div className="mb-3 text-4xl font-bold tracking-tight text-brand-500 sm:text-5xl">{c.n}</div>
                                                        <p className="text-[13px] font-semibold">{c.l}</p>
                                                        <p className="mt-1 text-[11px] text-gray-400 dark:text-gray-500">{c.s}</p>
                                                    </div>
                                                </Reveal>
                                            ))}
                                        </div>
                                ...
                                {i === 3 && (
                                    <>
                                        <Reveal active={a === 3}><p className="mb-5 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-brand-500">Revenue Model</p></Reveal>
                                        <Reveal active={a === 3} delay={100}><h2 className="mb-6 max-w-3xl text-[clamp(1.75rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight">Two revenue streams. <span className="text-brand-500 italic">Predictable growth.</span></h2></Reveal>
                                        <Reveal active={a === 3} delay={200}><p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">SaaS subscription for analytics + usage-based Parcel Journey billing. Sellers pay more as they grow.</p></Reveal>
                                        ...
                                        <Reveal active={a === 3} delay={500}>
                                            <div className="mt-6 overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                                ...
                                                <div className="grid gap-px bg-gray-100 sm:grid-cols-2 lg:grid-cols-4 dark:bg-white/5">
                                                    {[
                                                        ...
                                                        <div key={item.label} className="bg-white px-5 py-4 dark:bg-zinc-900/80">
                                        ...
                                        <Reveal active={a === 3} delay={650}>
                                            <div className="mt-4 overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                                ...
                                                {[
                                                    ...
                                                    <div key={r.phase} className="border-b border-gray-100 px-7 py-4 last:border-0 dark:border-white/5">
                                        ...
                                        <Reveal active={a === 3} delay={800}>
                                            <div className="mt-4 overflow-hidden rounded-2xl border-2 border-brand-500/80 shadow-xl shadow-brand-500/8 dark:border-brand-500/60">
                                                <div className="bg-gradient-to-r from-brand-50/90 to-white px-7 py-6 dark:from-brand-500/[0.06] dark:to-zinc-900">
                                                    ...
                                                    <div className="flex flex-wrap items-baseline gap-x-8 gap-y-3">
                                                        <div><span className="text-3xl font-bold tracking-tight text-brand-600 dark:text-brand-400">₱712k</span><span className="ml-1.5 text-sm text-gray-400">MRR at Month 12</span></div>
                                                        <div><span className="text-2xl font-bold tracking-tight">₱8.5M</span><span className="ml-1.5 text-sm text-gray-400">ARR run rate</span></div>
                                                        <div><span className="text-2xl font-bold tracking-tight">₱4.5M</span><span className="ml-1.5 text-sm text-gray-400">total Year 1 revenue</span></div>
                                                        <div><span className="text-2xl font-bold tracking-tight">250</span><span className="ml-1.5 text-sm text-gray-400">paying customers</span></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </Reveal>
                                ...
                                {i === 4 && (
                                    <>
                                        <Reveal active={a === 4}><p className="mb-5 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-brand-500">Equity Structure</p></Reveal>
                                        <Reveal active={a === 4} delay={100}><h2 className="mb-6 max-w-3xl text-[clamp(1.75rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight">Fair equity for <span className="text-brand-500 italic">real contribution.</span></h2></Reveal>
                                        <Reveal active={a === 4} delay={200}><p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">I built Artemis from zero. You helped make it better. This is how I propose we share ownership.</p></Reveal>
                                        <Reveal active={a === 4} delay={300}>
                                            <div className="grid gap-4 md:grid-cols-4">
                                                {[
                                                    ...
                                                    <div key={p.name} className={`relative overflow-hidden rounded-2xl border p-6 ${p.featured ? 'border-brand-500/80 bg-gradient-to-b from-brand-50/90 to-white shadow-xl shadow-brand-500/8 dark:border-brand-500/60 dark:from-brand-500/[0.06] dark:to-zinc-900' : 'border-gray-200/80 bg-white dark:border-white/6 dark:bg-zinc-900/80'}`}>
                                                        ...
                                                        <div className="mt-2 mb-1 text-3xl font-bold tracking-tight">{p.pct}</div>
                                                        <h3 className="mb-2 text-lg font-bold tracking-tight">{p.name}</h3>
                                                        <p className="text-[12px] leading-relaxed text-gray-500 dark:text-gray-400">{p.desc}</p>
                                                    </div>
                                                ))}
                                            </div>
                                        </Reveal>
                                ...
                                {i === 5 && (
                                    <>
                                        <Reveal active={a === 5}><p className="mb-5 font-mono text-[10px] font-semibold uppercase tracking-[0.25em] text-brand-500">Roles & Expectations</p></Reveal>
                                        <Reveal active={a === 5} delay={100}><h2 className="mb-6 max-w-3xl text-[clamp(1.75rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight">Everyone has a <span className="text-brand-500 italic">clear role.</span></h2></Reveal>
                                        <Reveal active={a === 5} delay={200}><p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">Equity is tied to contribution. Here's what each partner is expected to bring to the table.</p></Reveal>
                                                ...
                                                {[
                                                    ...
                                                    <Reveal key={s.n} active={a === 7} delay={300 + si * 100}>
                                                        <div className="rounded-2xl border border-gray-200/80 bg-white p-6 dark:border-white/6 dark:bg-zinc-900/80">
                                                            ...
                                                            <p className="text-[12px] leading-relaxed text-gray-500 dark:text-gray-400">{s.d}</p>
                                                        </div>
                                                    </Reveal>
                                                ))}
                                            </div>
