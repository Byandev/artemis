    ...
    return (
        <>
            <Head title="Contact — Artemis">
                <meta
                    name="description"
                    content="Get in touch with the Artemis team. Questions about the platform, partnerships, or support — we'd love to hear from you."
                />
            </Head>
                ...
                <section className="relative px-5 py-16 md:px-10 md:py-24">
                    <div className="mx-auto grid max-w-[1200px] items-start gap-12 lg:grid-cols-[1fr_1fr] lg:gap-20">
                        ...
                        <div className="lg:py-8">
                            ...
                            <h1 className="mb-5 text-[clamp(2rem,5vw,3rem)] leading-tight font-bold tracking-tight">
                                We'd love to{' '}
                            ...
                            <p className="mb-10 max-w-md text-base leading-relaxed text-gray-500 sm:text-lg dark:text-gray-400">
                                Questions about Artemis, partnership inquiries,
                                or just want to chat about COD e-commerce? Reach
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-4 rounded-2xl border border-gray-200/80 bg-white p-5 dark:border-white/6 dark:bg-zinc-900/80">
                                    ...
                                    <div>
                                        <p className="mb-0.5 font-mono text-[10px] tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                            Email
                                        </p>
                                        <a
                                            href="mailto:hello@artemis.ph"
                                            className="text-[15px] font-semibold text-gray-900 transition-colors hover:text-brand-500 dark:text-gray-100"
                                        >
                                            hello@artemis.ph
                                        </a>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-2xl border border-gray-200/80 bg-white p-5 dark:border-white/6 dark:bg-zinc-900/80">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-0.5 text-[13px] text-gray-400 dark:text-gray-500">
                                            Via Messenger during business hours
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="overflow-hidden rounded-2xl border border-black/6 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                            <div className="border-b border-black/4 bg-stone-50/80 px-6 py-5 sm:px-8 dark:border-white/5 dark:bg-white/[0.02]">
                            ...
                            {submitted ? (
                                <div className="px-6 py-16 text-center sm:px-8">
                                    ...
                                    <p className="text-[14px] text-gray-500 dark:text-gray-400">
                                        Salamat! We'll get back to you as soon
                                        as possible.
                                    </p>
                                </div>
                            ) : (
