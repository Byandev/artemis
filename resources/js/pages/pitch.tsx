                            ...
                            <div className="w-full max-w-5xl py-4 sm:py-8">
                                ...
                                {i === 8 && (
                                    <div className="relative text-center">
                                        ...
                                        <Reveal active={a === 8} delay={100}><h2 className="mb-2 text-[clamp(1.1rem,4.5vw,3.25rem)] font-bold leading-[1.08] tracking-tight sm:mb-6">Start your <span className="text-brand-500 italic">14-day free trial.</span></h2></Reveal>
