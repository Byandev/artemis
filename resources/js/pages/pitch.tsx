                                    ...
                                    <>
                                        ...
                                        <Reveal active={a === 7} delay={300}>
                                            <div className="grid gap-2 sm:gap-4 sm:grid-cols-3">
                                                {[{ plan: 'Starter', orders: '3,000 orders', bleed: '₱316,800', cost: '₱2,999/mo', be: '0.95%' }, { plan: 'Growth', orders: '10,000 orders', bleed: '₱1,056,000', cost: '₱5,999/mo', be: '0.57%' }, { plan: 'Scale', orders: '30,000 orders', bleed: '₱3,168,000', cost: '₱14,999/mo', be: '0.47%' }].map((r, ri) => (
