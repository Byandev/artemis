                            ...
                            <div className="w-full max-w-5xl py-8">
                                ...
                                {i === 2 && (
                                    <>
                                        ...
                                        <Reveal active={a === 2} delay={200}><p className="mb-12 max-w-2xl text-lg leading-relaxed text-gray-500 dark:text-gray-400">A mid-sized seller (3,000 orders/month) at 30% RTS bleeds <span className="font-semibold text-gray-900 dark:text-gray-100">₱316,800 every month</span>.</p></Reveal>
                                        <Reveal active={a === 2} delay={300}>
                                            <div className="overflow-hidden rounded-2xl border border-gray-200/80 bg-white shadow-sm dark:border-white/6 dark:bg-zinc-900/80">
                                                ...
                                                <div className="flex items-center justify-between bg-brand-50/60 px-7 py-5 dark:bg-brand-500/5"><span className="text-[15px] font-bold text-gray-900 dark:text-gray-100">Total per RTS parcel</span><span className="font-mono text-2xl font-bold text-brand-600 dark:text-brand-400">₱352</span></div>
                                            </div>
                                        </Reveal>
                                    </>
                                )}
                                ...
                                {i === 6 && (
                                    <>
                                        ...
                                        <Reveal active={a === 6} delay={200}><p className="mb-10 max-w-2xl text-base leading-relaxed text-gray-500 dark:text-gray-400">Pick the plan that fits your order volume. Parcel Journey billed at <span className="font-semibold text-gray-700 dark:text-gray-300">₱0.50–₱0.20 per tracked delivered order</span> — rate decreases as you scale.</p></Reveal>
                                        <Reveal active={a === 6} delay={300}>
                                            <div className="grid gap-4 md:grid-cols-4">
                                                {[{ name: 'Free Trial', price: '₱0', period: '14 days', orders: '∞', pages: '1', ret: '1 mo', pj: 'Free', sms: '—', sup: 'Chat', f: false }, { name: 'Starter', price: '₱1,499', period: '/mo', orders: '3,000', pages: '∞', ret: '3 mo', pj: '₱0.50/del.', sms: '—', sup: 'Chat', f: false }, { name: 'Growth', price: '₱3,999', period: '/mo', orders: '10,000', pages: '∞', ret: '6 mo', pj: '₱0.35/del.', sms: '3rd party API', sup: 'Priority', f: true }, { name: 'Scale', price: '₱9,999', period: '/mo', orders: '30,000', pages: '∞', ret: '12 mo', pj: '₱0.20/del.', sms: '3rd party API', sup: 'Dedicated', f: false }].map((t) => (
                                                    <div key={t.name} className={`relative flex flex-col overflow-hidden rounded-2xl border p-6 ${t.f ? 'border-brand-500 bg-gradient-to-b from-brand-50 via-white to-white shadow-2xl shadow-brand-500/15 ring-1 ring-brand-500/20 dark:border-brand-400 dark:from-brand-500/10 dark:via-zinc-900 dark:to-zinc-900 dark:shadow-brand-500/10 dark:ring-brand-400/10' : 'border-gray-200/80 bg-gradient-to-b from-white to-gray-50/50 shadow-lg shadow-gray-200/30 dark:border-white/8 dark:from-zinc-900 dark:to-zinc-900/80 dark:shadow-black/20'}`}>
                                                        ...
                                                        <div className="mt-2 mb-5 flex items-baseline gap-1"><span className={`text-3xl font-bold tracking-tight ${t.f ? 'text-brand-600 dark:text-brand-400' : ''}`}>{t.price}</span><span className="text-xs text-gray-400">{t.period}</span></div>
                                                        <div className="flex-1 space-y-2.5 border-t border-gray-100 pt-5 text-[11px] dark:border-white/5">
                                                            {[['Orders', `${t.orders}/mo`], ['Pages', t.pages], ['Data retention', t.ret], ['Parcel Journey', t.pj], ['PJ via SMS', t.sms], ['Support', t.sup]].map(([k, v]) => (
                                    ...
                                    <>
                                        ...
                                        <Reveal active={a === 7} delay={300}>
                                            <div className="grid gap-4 sm:grid-cols-3">
                                                {[{ plan: 'Starter', orders: '3,000 orders', bleed: '₱316,800', cost: '₱2,549/mo', be: '0.8%' }, { plan: 'Growth', orders: '10,000 orders', bleed: '₱1,056,000', cost: '₱6,449/mo', be: '0.6%' }, { plan: 'Scale', orders: '30,000 orders', bleed: '₱3,168,000', cost: '₱14,199/mo', be: '0.4%' }].map((r, ri) => (
