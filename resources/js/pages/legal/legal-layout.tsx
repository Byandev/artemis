                ...
                <article className="relative px-5 py-16 md:px-10 md:py-24">
                    <div className="mx-auto max-w-[720px]">
                        <header className="mb-12 border-b border-gray-200/80 pb-12 dark:border-white/6">
                            ...
                            <p className="font-mono text-[11px] tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                Last updated: {lastUpdated}
                            </p>
                        </header>

                        <div className="[&_strong]:font-semibold [&_strong]:text-gray-900 dark:[&_strong]:text-gray-200 [&>h2]:mt-12 [&>h2]:mb-4 [&>h2]:text-xl [&>h2]:font-bold [&>h2]:tracking-tight [&>h2]:text-gray-900 sm:[&>h2]:text-2xl dark:[&>h2]:text-gray-100 [&>h3]:mt-8 [&>h3]:mb-3 [&>h3]:text-lg [&>h3]:font-bold [&>h3]:tracking-tight [&>h3]:text-gray-900 dark:[&>h3]:text-gray-100 [&>p]:mb-5 [&>p]:text-[15px] [&>p]:leading-[1.8] [&>p]:text-gray-600 dark:[&>p]:text-gray-400 [&>ul]:mb-5 [&>ul]:space-y-2 [&>ul]:pl-0 [&>ul>li]:relative [&>ul>li]:pl-5 [&>ul>li]:text-[15px] [&>ul>li]:leading-[1.8] [&>ul>li]:text-gray-600 [&>ul>li]:before:absolute [&>ul>li]:before:top-[11px] [&>ul>li]:before:left-0 [&>ul>li]:before:h-1.5 [&>ul>li]:before:w-1.5 [&>ul>li]:before:rounded-full [&>ul>li]:before:bg-gray-300 dark:[&>ul>li]:text-gray-400 dark:[&>ul>li]:before:bg-gray-600">
                            {children}
                        </div>

                        {/* Related legal pages */}
                        <div className="mt-16 border-t border-gray-200/80 pt-8 dark:border-white/6">
                            <p className="mb-4 font-mono text-[10px] tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                Other legal pages
                            </p>
