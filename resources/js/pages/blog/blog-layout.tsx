...
>>>>>>> 0535f1b9 (frontend blogpost)
                    ...
                    <header className="mb-12 border-b border-gray-200/80 pb-12 dark:border-white/6">
                        ...
                        <h1 className="mb-5 text-[clamp(1.75rem,5vw,2.75rem)] leading-[1.1] font-bold tracking-tight">
                            {title}
                        </h1>
                        {description && (
                            <p className="mb-6 max-w-xl text-[17px] leading-relaxed text-gray-500 dark:text-gray-400">
                                {description}
                            </p>
                        )}
...
>>>>>>> 0535f1b9 (frontend blogpost)
                    ...
                    <div className="relative overflow-hidden rounded-2xl border-2 border-brand-500/60 shadow-xl shadow-brand-500/5 dark:border-brand-500/40">
                        ...
                        <div className="relative bg-gradient-to-b from-brand-50/90 to-white px-6 py-10 text-center sm:px-10 sm:py-12 dark:from-brand-500/[0.06] dark:to-zinc-900">
                            ...
                            <p className="mx-auto mb-8 max-w-md text-[14px] leading-relaxed text-gray-500 dark:text-gray-400">
                                Connect 1 Pancake page, get 1 month of data.
                                Parcel Journey tracking via chat. No credit card
                                required.
                            </p>
