...
const posts = [
    {
        ...
        description:
            "Return-to-sender isn't just a logistics problem — it's the single biggest profit leak in Philippine COD e-commerce. Here's what every seller needs to understand.",
    ...
    },
    {
        ...
        description:
            "Most sellers think RTS only costs them the shipping fee. The real number is 3-5x higher. We break down every peso you're actually losing.",
        category: 'Analytics',
        date: 'April 12, 2026',
        readTime: '4 min read',
    },
    {
        ...
        description:
            "When customers know where their parcel is, they're more likely to be home for delivery. Here's how notification-based tracking cuts return rates.",
        category: 'Product',
        date: 'April 10, 2026',
        readTime: '4 min read',
    },
    {
        ...
        description:
            "You might be profitable on paper but losing thousands every month. These are the red flags most PH COD sellers miss — until it's too late.",
        category: 'Operations',
        date: 'April 8, 2026',
        readTime: '6 min read',
    },
    {
        ...
        description:
            "The COD market is getting more competitive. Sellers who track their numbers will survive. Sellers who don't will keep guessing — and losing.",
        category: 'Industry',
        date: 'April 5, 2026',
        readTime: '5 min read',
    },
                ...
                <div className="mx-auto max-w-[1200px]">
                    ...
                    <div className="mb-16 text-center md:mb-20">
                        ...
                        <p className="mx-auto max-w-lg text-base leading-relaxed text-gray-500 sm:text-lg dark:text-gray-400">
                            Strategies, data, and practical guides to help you
                            cut RTS and protect your margin.
                        </p>
                    </div>
                    ...
                    >
                        <div className="absolute top-0 right-0 left-0 h-0.5 bg-gradient-to-r from-brand-400 to-brand-600 opacity-0 transition-opacity group-hover:opacity-100" />
                        <div className="p-8 sm:p-10 md:p-12">
                            <div className="mb-5 flex flex-wrap items-center gap-3">
                                <span className="inline-flex items-center gap-1.5 rounded-full border border-brand-200/60 bg-brand-50/80 px-3 py-1 font-mono text-[10px] font-semibold tracking-[0.15em] text-brand-700 uppercase dark:border-brand-500/15 dark:bg-brand-500/8 dark:text-brand-400">
                        ...
                        {posts.slice(1).map((post) => (
                            ...
                            >
                                ...
                                <div className="mb-4 flex items-center gap-2.5">
                                    <span className="inline-flex items-center rounded-full border border-brand-200/60 bg-brand-50/80 px-2.5 py-0.5 font-mono text-[9px] font-semibold tracking-[0.15em] text-brand-700 uppercase dark:border-brand-500/15 dark:bg-brand-500/8 dark:text-brand-400">
                                        {post.category}
                                    </span>
                                ...
                                <h2 className="mb-3 text-[15px] leading-snug font-bold tracking-tight text-gray-900 transition-colors group-hover:text-brand-600 sm:text-[16px] dark:text-gray-100 dark:group-hover:text-brand-400">
                                    {post.title}
                                </h2>
