        ...
        <div className="rounded-[14px] border border-black/6 bg-white p-[18px] dark:border-white/6 dark:bg-zinc-900">
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
                {[0, 1, 2].map((i) => (
                    <div
                        key={i}
                        className="rounded-xl bg-gray-50 p-3 dark:bg-zinc-800"
                    >
                            ...
                            <TooltipContent className="max-w-xs">
                                <div className="space-y-1.5">
                                    <p>
                                        ...
                                        new customers who placed their first
                                        order in the selected {period}-day
                                        window, this shows the percentage who
                                        returned within 30, 60, and 90 days.
                                    </p>
                                </div>
                            </TooltipContent>
                        </Tooltip>
                ...
                {windows.map(({ label, key }) => {
                    ...
                    return (
                        <div key={key} className={`rounded-xl p-3 ${bgClass}`}>
                            ...
                            <p
                                className={`mt-1 font-mono text-[20px] font-semibold tracking-tight tabular-nums ${colorClass}`}
                            >
