...
import { AVAILABLE_AD_METRICS, Campaign, MetricFilter, PaginatedCampaigns } from '@/types/models/AdManager';
...
const CampaignsPage = ({ workspace, campaigns, query }: PageProps) => {
