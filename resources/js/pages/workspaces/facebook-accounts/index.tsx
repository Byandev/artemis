...
const FacebookAccounts = ({
    ...
    const columns: ColumnDef<FacebookAccount>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) =>
                moment(row.original.created_at).format('MMM D, YYYY h:mm:ss A'),
        },
    ];
        ...
        <AppLayout>
            <div className="mx-auto w-full max-w-(--breakpoint-2xl) p-4 md:p-6">
                <PageHeader
                    ...
                    description="Connect and manage your Facebook business accounts"
                >
                    <button
                        onClick={connectFacebookAccount}
                        className="rounded-xl bg-brand-500 px-4 py-2 text-theme-sm font-medium text-white"
                    >
                    ...
                    <ComponentCard desc="List of  connected facebook accounts">
                        <div>
                            ...
                            <DataTable
                                ...
                                onFetch={(params) => {
                                    router.get(
                                        workspaces.facebookAccounts.index({
                                            workspace,
                                        }),
                                        {
                                            sort: params?.sort,
