...
export default function RuleForm({
    ...
    const canManage = usePermission(PERMISSIONS.ManageOptimizationRules);
    // View-only users (edit route allows View) get a read-only detail page.
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head
                title={`${workspace.name} - ${readOnly ? 'View' : isEdit ? 'Edit' : 'Create'} Optimization Rule`}
            />
                    ...
                    >
                        ...
                        <div className={sectionClass}>
                            ...
                            <div className="grid gap-5 sm:grid-cols-2">
                                ...
                                >
                                    {options.adAccounts.length === 0 ? (
                                        <p className="rounded-[10px] border border-dashed border-black/10 px-3 py-2.5 font-mono text-[11px] text-gray-400 dark:border-white/10 dark:text-gray-500">
                                            No synced ad accounts. Connect one
                                            under Meta Ads → Ad Accounts first.
                                        </p>
                                    ) : (
                                        <MultiSelect
                                ...
                                <Field label="Priority" error={errors.priority}>
                                    ...
                                    />
                                    <p className="font-mono text-[10px] text-gray-400 dark:text-gray-500">
                                        Higher wins when two rules target the
                                        same campaign or ad set in a run.
                                    </p>
                                </Field>
                            </div>
                        </div>
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="flex items-center justify-between rounded-[10px] border border-black/8 bg-stone-50 px-4 py-3 dark:border-white/8 dark:bg-zinc-800">
                                    <div>
                                        ...
                                        <p className="font-mono text-[10px] text-gray-400 dark:text-gray-500">
                                            Inactive rules are saved but never
                                            run.
                                        </p>
                                    </div>
                                    <Switch
                        ...
                        <div className={sectionClass}>
                            ...
                            <p className="mt-3 font-mono text-[10px] text-gray-400 dark:text-gray-500">
                                Schedules align to the clock — e.g. “Every 3
                                hours” runs at 00:00, 03:00, 06:00 … Times use
                                the server timezone.
                            </p>
                        </div>
                    </fieldset>
