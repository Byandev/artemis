...
/** The multi-select filters managed by this popover (all arrays). */
...
/**
 * Multi-select filter popover for the Creative Tracker list, styled to match the
 * main dashboard's Filters control (sliders trigger + grouped multi-select
 * sections + an explicit "Apply Changes" action and a "Clear all" reset).
 */
export default function CreativesFilter({
    value,
    formatOptions,
    adsStatusOptions,
    finalStatusOptions,
    ...
    const [localValue, setLocalValue] = useState<CreativesFilterValue>(value);
    ...
    const toggle = useCallback(
        (key: keyof CreativesFilterValue, id: string) => {
            setLocalValue((prev) => {
            ...
            >
                ...
                <div className="max-h-72 space-y-1 overflow-y-auto p-2">
                    ...
                    <MultiSelectGroup
                        ...
                        selected={localValue.ads_statuses}
                        onToggle={(id) => toggle('ads_statuses', id)}
                    />
                    <MultiSelectGroup
                        name="Creator"
