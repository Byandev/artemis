    ...
    return (
        <AppLayout>
            ...
            <div className="mx-auto w-full max-w-(--breakpoint-2xl) p-4 md:p-6">
                <PageHeader
                    title="Dashboard"
                    description="Finance overview — cashflow, burn, and expense trends."
                >
                    <DatePicker
                ...
                <div
                    className={`grid grid-cols-1 gap-3 ${hasBurn ? 'sm:grid-cols-2 lg:grid-cols-3' : 'sm:grid-cols-1'}`}
                >
                    <StatCard
                ...
                {hasCashflow && (
                    <div className="mt-6 rounded-[14px] border border-black/6 bg-white p-4 dark:border-white/6 dark:bg-zinc-900">
                        <div className="mb-3 flex items-center justify-between">
                            <div>
                                <div className="font-mono text-[11px] font-medium tracking-wider text-gray-400 uppercase dark:text-gray-500">
                                    Cashflow
                                </div>
                                                ...
                                                >
                                                    <div className="mb-1.5 flex items-center justify-between">
                                                        <div className="flex items-center gap-2">
                                                            <span
                                                                className={`inline-block h-2 w-2 rounded-full ${swatch}`}
                                                            />
                                                    ...
                                                    <div className="h-1.5 w-full overflow-hidden rounded-full bg-gray-100 dark:bg-white/5">
                                                        <div
                                                            className={`${swatch} h-full rounded-full transition-all`}
                                                            style={{
                                                                width: `${pct}%`,
                                                            }}
                                                        />
                            ...
                            <div className="rounded-[14px] border border-black/6 bg-white dark:border-white/6 dark:bg-zinc-900">
                                <div className="border-b border-black/6 px-5 py-3 dark:border-white/6">
                                    ...
                                    <div className="text-[11px] text-gray-400">
                                        Compared against the equivalent window
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-[12px]">
                                        <thead>
                                            <tr className="text-left font-mono text-[10px] tracking-wider text-gray-400 uppercase">
                                            ...
                                            {sortedMoM
                                                ...
                                                .map((row) => (
                                                    <tr key={row.sub_category}>
                                                        <td className="px-5 py-2 text-gray-800 dark:text-gray-100">
                                                            {labelFor(
                                                                row.sub_category,
                                                            )}
                                                        </td>
...
function DeltaBadge({
    ...
    const pctLabel =
        deltaPct == null ? 'new' : `${Math.abs(deltaPct).toFixed(1)}%`;
    return (
        <span
            className={`inline-flex items-center gap-1 font-mono text-[11px] ${color}`}
        >
