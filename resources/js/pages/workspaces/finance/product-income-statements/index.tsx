...
const closingColumns = (
    ...
    {
        label: 'OPEX Share',
        help: 'This product\u2019s delivered orders as a percentage of every row\u2019s on this statement \u2014 the split the OPEX beside it was struck from. Saved with the statement, so it still reads back after a later sync moves the underlying counts.',
        render: (r) => sharePct(r.opex_share_percentage),
    },
    {
        label: 'Less — OPEX',
        help: 'This product\u2019s share of the month\u2019s operating expenses, by its delivered orders over every row\u2019s. Nothing in the OPEX pool is booked against a single product, so the share is allocated rather than measured \u2014 a row that delivered nothing carries none of it.',
        render: (r) => fmt(r.opex),
    },
    {
        label: '= Net Profit',
    ...
    ...(cogsView === 'bought'
        ? [
              ...
              ...(gencysPartner
                  ...
                  : []),
              ...closingColumns((r: ProductRow) => r.net_profit_bought_cogs),
          ]
        : [
              {
              ...
              ...(gencysPartner
                  ...
                  : []),
              ...closingColumns((r: ProductRow) => r.net_profit_delivered_cogs),
          ]),
];
