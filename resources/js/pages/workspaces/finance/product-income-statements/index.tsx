...
const buildRows = (
    ...
    return [
        ...
        },
        {
            ...
            help: 'What was carried into the month, added up from this product’s sellers — the figures are entered on the Seller × Product page, which is the finest grain they are stated at. Nought here means none was entered against this product.',
            render: (r) => fmt(r.loss_brought_forward),
        },
        {
            label: '= Cumulative Profit',
            help: 'Net Profit less the loss carried in — what this product is actually up, counting where it started the month.',
            render: (r) =>
                fmt(
                    cogsView === 'bought'
