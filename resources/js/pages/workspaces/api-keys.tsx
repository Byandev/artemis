    ...
    const toggleVisible = async (key: ApiKey) => {
        ...
        try {
            const res = await axios.get(
                `/workspaces/${workspace.slug}/api-keys/${key.id}/reveal`,
            );
        ...
        <AppLayout>
            ...
            <div className="mx-auto w-full max-w-(--breakpoint-2xl) p-4 md:p-6">
                            ...
                            <div className="border-b border-black/6 px-5 pt-5 pb-4 dark:border-white/6">
                                <DialogHeader>
                                    ...
                                    <DialogDescription className="mt-0.5 text-[12px] text-gray-400 dark:text-gray-500">
                                        Give this key a name so you remember
                                        where it's used.
                                    </DialogDescription>
                                </DialogHeader>
                            </div>
                    ...
                    {apiKeys.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-14 text-center">
                            ...
                            <p className="mt-1 font-mono text-[11px] text-gray-400 dark:text-gray-500">
                                Create a key to start integrating with external
                                platforms.
                            </p>
                        </div>
                    ) : (
                ...
                <div className="mt-4 rounded-xl border border-black/5 bg-gray-50 p-4 dark:border-white/5 dark:bg-zinc-900">
                    <p className="mb-1.5 font-mono text-[10px] font-semibold tracking-wider text-gray-400 uppercase dark:text-gray-500">
                        Usage
                    </p>
