...
Route::group(['prefix' => 'v1/public', 'as' => 'api.v1.public.', 'middleware' => ['api.key']], function () {
    ...
    Route::post('/call-logs/sync', [\App\Http\Controllers\PublicApi\CallLogController::class, 'sync'])->name('call-logs.sync');
    Route::get('/call-logs/kpi', [\App\Http\Controllers\PublicApi\CallLogController::class, 'kpi'])->name('call-logs.kpi');
});
